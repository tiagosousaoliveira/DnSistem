...
public class TragesNoiva extends JFrame {
	...
	JLabel tamanho1 																		= new JLabel("Pe\u00E7a adicional 1\u00BA");
	JLabel tamanho2 																		= new JLabel("Pe\u00E7a adicional 2\u00BA");
...
panel.add(combo);		panel.add(menu);
	...
	public void passagem(){
		TrageNoiva noiva = new TrageNoiva();
			...
			noiva.setId(cod);
			noiva.setQuantidade(qua);
			noiva.setNome(nome_v.getText());
			noiva.setDetalhes(detalhes_v.getText());
			noiva.setCor(cor_v.getText());
			noiva.setEstilo(estilo_v.getText());
			noiva.setOpcao1(Peça1.getText());
			noiva.setOpcao2(Peça2.getText());
			noiva.setObs(obs_v.getText());
			noiva.setValor(valor_v.getText());
			noiva.setAltura(altura_v.getText());
			noiva.setLargura(largura_v.getText());
			noiva.setBusto(busto_v.getText());
			noiva.setManga(manga_v.getText());
			noiva.setModelo1(combo.getSelectedItem().toString());
			noiva.setData_cadastro(data_cadastro.getText());
			noiva.setCintura(cintura_v.getText());
			
			ControleNoiva control = new ControleNoiva();
			control.ControleEscolhaCadastroaba1(noiva);
			
			if(ConexaoNoiva.retorno==1){
			       JOptionPane.showMessageDialog(null, " Gravação Concluida com Sucesso ");
			}else if(ConexaoNoiva.retorno==2){
				   JOptionPane.showMessageDialog(null, " 'Erro no Processo com o Banco' ");
			}
	
	}
	public void retorno(TrageNoiva noiva){

			codigo.setText(""+noiva.getId());
			nome_v.setText(""+noiva.getNome());
			detalhes_v.setText(""+noiva.getDetalhes());
			cor_v.setText(""+noiva.getCor());
			estilo_v.setText(""+noiva.getEstilo());
			Peça1.setText(""+noiva.getOpcao1());
			Peça2.setText(""+noiva.getOpcao2());
			obs_v.setText(""+noiva.getObs());
			valor_v.setText(""+noiva.getValor());
			quantidade.setText(""+noiva.getQuantidade());
			altura_v.setText(""+noiva.getAltura());
			largura_v.setText(""+noiva.getLargura());
			busto_v.setText(""+noiva.getBusto());
			manga_v.setText(""+noiva.getManga());
			data_cadastro.setText(""+noiva.getData_cadastro());
			cintura_v.setText(""+noiva.getCintura());
			combo.setSelectedItem(""+noiva.getModelo1());
