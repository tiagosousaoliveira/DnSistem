...
import CamadaControle.ControleDama;
...
public class TragesDamadeHonra extends JFrame {
...
panel.add(combo);		panel.add(menu);
	...
	public void passagem(){
		TrageDamaHonra dama = new TrageDamaHonra();
			...
			dama.setId(cod);
			dama.setQuantidade(qua);
			dama.setNome(nome_v.getText());
			dama.setDetalhes(detalhes_v.getText());
			dama.setCor(cor_v.getText());
			dama.setEstilo(estilo_v.getText());
			dama.setOpcao1(Peça1.getText());
			dama.setOpcao2(Peça2.getText());
			dama.setObs(obs_v.getText());
			dama.setValor(valor_v.getText());
			dama.setAltura(altura_v.getText());
			dama.setLargura(largura_v.getText());
			dama.setBusto(busto_v.getText());
			dama.setManga(manga_v.getText());
			dama.setModelo1(combo.getSelectedItem().toString());
			dama.setData_cadastro(data_cadastro.getText());
			dama.setCintura(cintura_v.getText());
			
			ControleDama control = new ControleDama();
			control.ControleEscolhaCadastroaba1(dama);
			
			if(ConexaoDama.retorno==1){
			       JOptionPane.showMessageDialog(null, " Gravação Concluida com Sucesso ");
			}else if(ConexaoDama.retorno==2){
				   JOptionPane.showMessageDialog(null, " 'Erro no Processo com o Banco' ");
			}
	
	}
	public void retorno(TrageDamaHonra dama){

			codigo.setText(""+dama.getId());
			nome_v.setText(""+dama.getNome());
			detalhes_v.setText(""+dama.getDetalhes());
			cor_v.setText(""+dama.getCor());
			estilo_v.setText(""+dama.getEstilo());
			Peça1.setText(""+dama.getOpcao1());
			Peça2.setText(""+dama.getOpcao2());
			obs_v.setText(""+dama.getObs());
			valor_v.setText(""+dama.getValor());
			quantidade.setText(""+dama.getQuantidade());
			altura_v.setText(""+dama.getAltura());
			largura_v.setText(""+dama.getLargura());
			busto_v.setText(""+dama.getBusto());
			manga_v.setText(""+dama.getManga());
			data_cadastro.setText(""+dama.getData_cadastro());
			cintura_v.setText(""+dama.getCintura());
			combo.setSelectedItem(""+dama.getModelo1());
