...
public class TeaLogon extends JFrame {
...
//=======================================================================================================================================//		
		ImageIcon db = new ImageIcon (getClass().getResource("img/Logon/newdb.png"));
		db.setImage(db.getImage().getScaledInstance(20, 15, 15));
			JLabel bdd = new JLabel(db);
				bdd.setLocation(300,120);
				bdd.setSize(60,52);
	
		ImageIcon noivos = new ImageIcon (getClass().getResource("img/Logon/noivos.png"));
...
//=====================================================================================================================================//
	...
	public static void main (String args[]){
		TeaLogon.setDefaultLookAndFeelDecorated(true);
