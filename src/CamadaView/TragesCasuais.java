...
import CamadaControle.ControleCasuais;
import CamadaDao.ConexaoCasuais;
import CamadaModel.TrageCasuais;


public class TragesCasuais extends JFrame {
...
panel.add(combo);		panel.add(menu);
	...
	public void passagem(){
		TrageCasuais outros = new TrageCasuais();
			...
			outros.setId(cod);
			outros.setQuantidade(qua);
			outros.setNome(nome_v.getText());
			outros.setDetalhes(detalhes_v.getText());
			outros.setCor(cor_v.getText());
			outros.setEstilo(estilo_v.getText());
			outros.setOpcao1(Peça1.getText());
			outros.setOpcao2(Peça2.getText());
			outros.setObs(obs_v.getText());
			outros.setValor(valor_v.getText());
			outros.setAltura(altura_v.getText());
			outros.setLargura(largura_v.getText());
			outros.setBusto(busto_v.getText());
			outros.setManga(manga_v.getText());
			outros.setModelo1(combo.getSelectedItem().toString());
			outros.setData_cadastro(data_cadastro.getText());
			outros.setCintura(cintura_v.getText());
			
			ControleCasuais control = new ControleCasuais();
			control.ControleEscolhaCadastroaba1(outros);
			
			if(ConexaoCasuais.retorno==1){
			       JOptionPane.showMessageDialog(null, " Gravação Concluida com Sucesso ");
			}else if(ConexaoCasuais.retorno==2){
				   JOptionPane.showMessageDialog(null, " 'Erro no Processo com o Banco' ");
			}
	
	}
	public void retorno(TrageCasuais outro){

			codigo.setText(""+outro.getId());
			nome_v.setText(""+outro.getNome());
			detalhes_v.setText(""+outro.getDetalhes());
			cor_v.setText(""+outro.getCor());
			estilo_v.setText(""+outro.getEstilo());
			Peça1.setText(""+outro.getOpcao1());
			Peça2.setText(""+outro.getOpcao2());
			obs_v.setText(""+outro.getObs());
			valor_v.setText(""+outro.getValor());
			quantidade.setText(""+outro.getQuantidade());
			altura_v.setText(""+outro.getAltura());
			largura_v.setText(""+outro.getLargura());
			busto_v.setText(""+outro.getBusto());
			manga_v.setText(""+outro.getManga());
			data_cadastro.setText(""+outro.getData_cadastro());
			cintura_v.setText(""+outro.getCintura());
			combo.setSelectedItem(""+outro.getModelo1());
